package kr.ecommerce.be.server.domain.payment.service.mapper;
...
import kr.ecommerce.be.server.domain.payment.mapper.PaymentMapper;
import kr.ecommerce.be.server.domain.payment.mapper.PaymentMapperImpl;
