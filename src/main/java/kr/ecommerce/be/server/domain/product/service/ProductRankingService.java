package kr.ecommerce.be.server.domain.product.service;

import io.github.resilience4j.circuitbreaker.annotation.CircuitBreaker;
import kr.ecommerce.be.server.domain.product.assembler.ProductAssembler;
...
import kr.ecommerce.be.server.domain.product.model.ProductRanking;
import kr.ecommerce.be.server.domain.product.model.ProductScore;
import kr.ecommerce.be.server.domain.product.model.vo.ProductCacheKey;
import kr.ecommerce.be.server.domain.product.model.vo.ProductRankingKey;
import kr.ecommerce.be.server.domain.product.repository.ProductRepository;
